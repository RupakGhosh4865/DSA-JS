...
//         memo[amount]= coinSum(amount.coins,memo)
//     }
//     return memo[amount]
...
{   
    ...
    for(let i=0;i<coins.length;i++){
        if(coinSum1(amount-coins[i],coins,memo)){
            memo[amount] = true
            return true
        }
    }
...
console.log(coinSum1(300, [7, 14]));      // false (cannot sum to 300 with these coin